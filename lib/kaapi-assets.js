...
export const KAAPI_LOGO = '/kaapi/logo-alt.png';
...
export const KAAPI_THEMES = {
  ...
  light: {
    ...
    colors: {
      ...
      watermarkColor: 'rgba(74,42,21,0.09)',
      canvasBg: '#F4EDE0',
      backdropRadial: ['rgba(201,169,138,0.32)', 'rgba(138,90,60,0.10)', 'rgba(244,237,224,0)'],
      vignette: ['rgba(244,237,224,0)', 'rgba(244,237,224,0.35)', 'rgba(244,237,224,0.75)'],
    },
    images: { intact: '/kaapi/cream-intact.png', exploded: '/kaapi/cream-exploded.png' },
    clips: {
      deconstruct: { source: 'image', image: 'exploded', kind: 'reveal' },
      orbit:       { source: 'image', image: 'intact',   kind: 'orbit'  },
      bridge:      { source: 'image', image: 'intact',   kind: 'bridge' },
      detail:      { source: 'image', image: 'intact',   kind: 'detail' },
    },
